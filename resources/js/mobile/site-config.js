(function(){
    ...
    _pw_env = {
        ...
        pkgs:[
            {
                name: 'pio',
                path: site.staticWebsite + 'resources/js/mobile/'
            },
            {
                name: 'widget',
        ...
        modSettings:{
            ...
            dialog:{
                ...
                content: '暂无内容！',
                // themeUrl: site.staticWebsite + 'resources/tool/base-widget/css/core.css'
                themeUrl: site.staticWebsite + 'resources/css/mobile/common/dialog.css'
            },
            defender:{
                themeUrl: site.staticWebsite + 'resources/tool/base-widget/css/core.css'
            },
            iscroll:{
                themeUrl: site.staticWebsite + 'resources/css/mobile/common/pull-push.css'
            },
            pagination: {
                themePackage: {
            ...
            select:{
                themeUrl: site.staticWebsite + 'resources/tool/base-widget/css/select.css'
            },
            // 文件上传swf路径
            upload: {
